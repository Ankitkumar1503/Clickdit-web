    ...
    <>
      ...
      <section className="py-0 position-relative">
        ...
        <div className="bg-dark position-relative overflow-hidden py-8">
          ...
          <div
            data-bs-theme="dark"
            className="position-relative pt-5 pt-sm-8 container"
          >
            <div className="row">
      ...
      <>
        ...
        <section className="pt-0">
          <div className="position-relative container">
            <div className="avatar avatar-xl flex-shrink-0 position-absolute top-0 start-0 mt-6 ms-n3 z-index-2 d-none d-lg-block">
              <img
                className="avatar-img rounded-circle position-relative"
                src="https://themes.stackbros.in/folio-react/assets/10-55zuZDDJ.jpg"
                alt="avatar"
              />
            </div>
            <div className="avatar flex-shrink-0 position-absolute top-0 start-50 translate-middle-x ms-n9 mt-n2 z-index-2 d-none d-lg-block">
              <img
                className="avatar-img rounded-circle position-relative"
            ...
            <div className="avatar avatar-lg flex-shrink-0 position-absolute top-0 end-0 me-7 mt-n4 z-index-2 d-none d-lg-block">
              <img
                className="avatar-img rounded-circle position-relative"
            ...
            <div className="avatar avatar-xl flex-shrink-0 position-absolute bottom-50 end-0 mb-n8 me-n4 z-index-2 d-none d-lg-block">
              <img
                className="avatar-img rounded-circle position-relative"
            ...
            <div className="avatar avatar-lg flex-shrink-0 position-absolute bottom-0 end-0 me-9 mb-4 z-index-2 d-none d-lg-block">
              <img
                className="avatar-img rounded-circle position-relative"
            ...
            <div className="avatar flex-shrink-0 position-absolute bottom-0 start-0 ms-8 mb-n3 z-index-2 d-none d-lg-block">
              <img
                className="avatar-img rounded-circle position-relative"
            ...
            <div className="bg-secondary position-relative rounded-4 overflow-hidden p-5 py-md-7">
              <span className="position-absolute end-0 top-0 me-n5 mt-3">
                ...
                >
                  ...
                  />
                  <path
                    d="M169.945 49.2281V54.9619H175.679V49.2281H169.945Z"
                    fill="currentColor"
                  />
                  <path
                    d="M155.848 49.2281V54.9619H161.581V49.2281H155.848Z"
                    fill="currentColor"
                  />
                  <path
                    d="M141.766 49.2281V54.9619H147.499V49.2281H141.766Z"
                    fill="currentColor"
                  />
                  <path
                    d="M308.512 80.0182V85.752H314.246V80.0182H308.512Z"
                    fill="currentColor"
                  />
                  <path
                    d="M283.973 80.0182V85.752H289.706V80.0182H283.973Z"
                    fill="currentColor"
                  />
                  <path
                    d="M259.449 80.0182V85.752H265.183V80.0182H259.449Z"
                    fill="currentColor"
                  />
                </svg>
              </span>
              <span className="position-absolute start-0 bottom-0 mb-3 ms-n5">
                ...
                >
                  ...
                  />
                  <path
                    d="M282.355 49.2281V54.9619H276.622V49.2281H282.355Z"
                    fill="currentColor"
                  />
                  <path
                    d="M296.453 49.2281V54.9619H290.719V49.2281H296.453Z"
                    fill="currentColor"
                  />
                  <path
                    d="M310.535 49.2281V54.9619H304.801V49.2281H310.535Z"
                    fill="currentColor"
                  />
                  <path
                    d="M143.789 80.0182V85.752H138.055V80.0182H143.789Z"
                    fill="currentColor"
                  />
                  <path
                    d="M168.328 80.0182V85.752H162.594V80.0182H168.328Z"
                    fill="currentColor"
                  />
                  <path
                    d="M192.852 80.0182V85.752H187.118V80.0182H192.852Z"
                    fill="currentColor"
                  />
                </svg>
              </span>
              <div className="position-relative row">
                <div className="mx-auto col-md-8">
                  <div className="swiper swiper-initialized swiper-horizontal pb-5 swiper-backface-hidden">
                    <div
                      className="swiper-wrapper"
                      style={{
                        transitionDuration: "300ms",
                        transform: "translate3d(-1606px, 0px, 0px)",
                      }}
                    >
                      <div
                        className="swiper-slide swiper-slide-next"
                        data-swiper-slide-index={2}
                        style={{ width: 773, marginRight: 30 }}
                      >
                        <div className="text-center">
                          <ul className="list-inline mb-3">
                            <li className="list-inline-item fs-6 me-0">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                xmlnsXlink="http://www.w3.org/1999/xlink"
                                aria-hidden="true"
                    ...
                    <div className="swiper-pagination swiper-pagination-primary position-absolute bottom-0 mb-3 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
