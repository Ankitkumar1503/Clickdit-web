...
function Contact() {
  return (
    <>
    <section
      className="bg-dark position-relative overflow-hidden pt-xl-8"
      data-bs-theme="dark"
    >
      ...
      <div className="position-relative pt-4 pt-sm-5 container">
        <span className="h2">👋</span>
        <h1 className="display-5 mt-3">Let's Connect</h1>
        <p className="mb-1">We’re here to help</p>
        <p>
          Support hours: <span className="text-primary fw-bold">24/7</span>
        </p>
      </div>
    </section>
  ...
  <div className="container">
    <div className="g-4 g-lg-5 row">
      <div className="col-md-4">
        <div className="bg-secondary rounded-4 p-4 h-100 card">
          <div className="p-0 card-body">
            <div className="icon-lg bg-pink text-white rounded-circle mb-3 icon_change">
              <svg
            ...
            <h6>Call us</h6>
            <p className="mb-0">
              Speak with a member of our team. We’re always ready to assist you.
            </p>
          </div>
          <div className="bg-transparent p-0 pt-3 card-footer">
            <a
      ...
      <div className="col-md-4">
        <div className="bg-secondary rounded-4 p-4 h-100 card">
          <div className="p-0 card-body">
            <div className="icon-lg bg-primary text-white rounded-circle mb-3 icon_change">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink"
                aria-hidden="true"
            ...
            <h6>Mail us</h6>
            <p className="mb-0">
              We’re prompt and aim to respond to all inquiries within 24 hours.
            </p>
          </div>
          <div className="bg-transparent p-0 pt-3 card-footer">
            <a
      ...
      <div className="col-md-4">
        <div className="bg-secondary rounded-4 p-4 h-100 card">
          <div className="p-0 card-body">
            <div className="icon-lg bg-warning text-white rounded-circle mb-3 icon_change">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink"
                aria-hidden="true"
          ...
          <div className="bg-transparent p-0 pt-3 card-footer">
            <a
              ...
              tabIndex={0}
              href=""
              className="icon-link icon-link-hover btn btn-white-shadow btn-sm"
            >
              Chat now
              <svg
                xmlns="http://www.w3.org/2000/svg"
...
<section className="position-relative pt-0">
  <div className="bg-secondary-grad rounded-4 p-4 p-md-6 p-xxl-4 container">
    <div className="inner-container-small">
      <h1 className="fw-bold mb-2 lh-base text-center icon_change">
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className="iconify iconify--bi me-2" width="1em" height="1em" viewBox="0 0 16 16">
          <g fill="currentColor">
          ...
          </g></svg>Say &nbsp;<span className="cd-headline clip big-clip is-full-width text-primary-grad mb-0"><span><span className="typed">Hello</span><span className="typist-cursor typed" style={{"opacity":"0","visibility":"visible","-webkit-animation":"700ms ease 100ms infinite normal none running                        _blink","animation":"700ms ease 100ms infinite normal none running                        _blink"}}>|</span></span></span>
      </h1>
      ...
      <form className="row form-border-transparent g-3 mt-4">
        <div className="col-md-6">
          <label className="form-label">Your name</label><input type="text" className="form-control" />
        </div>
        <div className="col-md-6">
          <label className="form-label">Email address</label><input type="email" className="form-control" id="floatingInput" />
        </div>
        <div className="col-md-6">
          <label className="form-label">Mobile number</label><input type="text" className="form-control" />
        </div>
        <div className="col-md-6">
          <label className="form-label">Subject</label><input type="text" className="form-control" />
        </div>
        <div className="col-12">
          <label className="form-label">Message</label><textarea className="form-control" id="floatingTextarea2" style={{"height":"100px"}} defaultValue={""} />
        </div>
        <div className="col-12">
          <div className="form-check">
            <input type="checkbox" className="form-check-input border" id="exampleCheck1" /><label className="form-check-label" htmlFor="exampleCheck1">I agree that my data is
              <a className="hover-underline-animation text-primary-hover" href="/#" data-discover="true">collected and stored</a>.</label>
          </div>
        </div>
        <div className="d-sm-flex align-items-center gap-3 mt-4 col-12">
          <button className="btn btn-primary mb-2 mb-md-0">
            Send a message
          </button>
          <ul className="list-inline mb-0 ms-auto">
            <li className="list-inline-item small heading-color">
              Connect with:
            </li>
            <li className="list-inline-item">
              <a className="heading-color text-primary-hover" href="/#" data-discover="true"><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className="iconify iconify--bi" width={16} height={16} viewBox="0 0 16 16">
            ...
            <li className="list-inline-item">
              <a className="heading-color text-primary-hover" href="/#" data-discover="true"><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className="iconify iconify--bi" width={16} height={16} viewBox="0 0 16 16">
                  <path fill="currentColor" d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07l-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z" /></svg></a>
            </li>
            <li className="list-inline-item">
              <a className="heading-color text-primary-hover" href="/#" data-discover="true"><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className="iconify iconify--bi" width={16} height={16} viewBox="0 0 16 16">
